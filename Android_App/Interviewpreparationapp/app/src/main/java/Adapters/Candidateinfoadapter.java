...
public class Candidateinfoadapter extends RecyclerView.Adapter<Candidateinfoadapter.MyViewHolder> {
    List<UserHelperClass> userlist;
    Context context;

    public Candidateinfoadapter(List<UserHelperClass> userlist, Context context) {
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new Candidateinfoadapter.MyViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        UserHelperClass interviewerrecivedreqhelper = userlist.get(position);
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (adapterPosition != RecyclerView.NO_POSITION) {
                    ...
                    UserHelperClass clickedItem = userlist.get(adapterPosition);
                    String userId = clickedItem.getMobileno(); // Assuming you have a method to get user ID
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                if (dataSnapshot.exists()) {
                    ...
                    if (userData != null) {
                        ...
                        Intent intent = new Intent(context, Candidateinfodataadmin.class);
